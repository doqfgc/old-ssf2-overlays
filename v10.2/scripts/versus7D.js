...
function runUpdate() {
	...
	if ($('#p1').get("innerHTML") != p1) {
        $('.dummy').animate({$$fade: 0}, 1).then(function() {
			...
			$('.player3').animate({$$fade: 0}, outSpeed).then(function() {
				$('#p2').set("innerHTML", p2);
				$.wait(250).then(function(){ 
					$('.player3').animate({$right: '-730px', $bottom: '301px'}, 1).then(function() {
						$('.player3').animate({$$fade: 1}, 1).then(function() {
	...
	if ($('#p3').get("innerHTML") != p3) {
        $('.dummy').animate({$$fade: 0}, 1).then(function() {
            ...
            $('.player4').animate({$$fade: 0}, outSpeed).then(function() {
                $('#p4').set("innerHTML", p4);
				$.wait(250).then(function(){ 
					$('.player4').animate({$right: '1272px', $bottom: '-171px'}, 1).then(function() {
						$('.player4').animate({$$fade: 1}, 1).then(function() {
